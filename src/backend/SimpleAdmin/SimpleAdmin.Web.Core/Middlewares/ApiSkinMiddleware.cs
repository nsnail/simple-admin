...
using SimpleAdmin.Core.Configuration.Options;

namespace SimpleAdmin.Web.Core.Middlewares;
...
public class RestSkinMiddleware
{
    ...
    private const string EMBEDDED_FILE_NAMESPACE = $"{nameof(SimpleAdmin)}.{nameof(Web)}.{nameof(Core)}.dist";
