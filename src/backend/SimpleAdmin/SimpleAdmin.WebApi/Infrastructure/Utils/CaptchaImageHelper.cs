...
public static class CaptchaImageHelper
{
        ...
        Size       sliderSize)
    {
        ...
        //深色模板图
        var templateIndex = new[] {
            tempIndexScope.Item1,
            tempIndexScope.Item2
        }.Rand();
        ...
        //随机生成拼图坐标
        var offsetRand = GeneratePoint(backgroundImage.Width,
        ...
        blockImage.Mutate(x => {
                              x.Clip(blockShape,
                                     ...
                                     p => p.DrawImage(backgroundImage, new Point(-offsetRand.X, -offsetRand.Y), 1));
                          });
