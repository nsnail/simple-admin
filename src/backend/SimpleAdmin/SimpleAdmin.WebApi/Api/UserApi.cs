...
{
    /// <inheritdoc />
    public UserApi(UserRepository rep)
    {
        _rep = rep;
    }
    ...
    /// <inheritdoc />
    public Task<ProfileRsp> GetProfile()
    {
        var sdfsdfsdf = App.User.Claims;
        return null;
        //return _rep.GetAsync(x=>x.Token == App.User.Claims
    }

    [NonUnify]
    [AllowAnonymous]
    public IActionResult GetProfile2()
    {
        return new JsonResult(mock.Object<dynamic>());
    }
}